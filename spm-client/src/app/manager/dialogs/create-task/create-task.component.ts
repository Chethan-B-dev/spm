...
export class CreateTaskComponent implements OnInit, OnDestroy {
  ...
  createTask(): void {
    ...
    this.managerService
      ...
      .subscribe(() => {
        ...
        this.sendTaskCreatedNotification(
  ...
  private sendTaskCreatedNotification(userId: number, taskName: string): void {
    const notification: INotification = {
      userId: userId,
      notification: `A new Task: '${taskName}' has been assigned to you on ${new Date().toLocaleString()}`,
      time: Date.now(),
    };
