...
//        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/manager/**").hasAnyAuthority("MANAGER");
//        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/auth/users").hasAnyAuthority("EMPLOYEE");
//        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/auth/users").hasAnyAuthority("MANAGER");

        http.authorizeRequests().antMatchers("/api/test").hasAnyAuthority("EMPLOYEE");
